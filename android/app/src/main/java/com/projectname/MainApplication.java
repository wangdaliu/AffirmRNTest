    ...
    private final ReactNativeHost mReactNativeHost =
            new ReactNativeHost(this) {
                ...
                protected List<ReactPackage> getPackages() {
                    ...
                    packages.add(new AffirmNativeReactPackage());
...
//        6YN1HYTDBEMFF8CK - VCN
//        Y8CQXFF044903JC0 - Not VCN

        Affirm.initialize(new Affirm.Configuration.Builder("6YN1HYTDBEMFF8CK")
